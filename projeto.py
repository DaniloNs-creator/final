...
class CTeProcessor:
    ...
    def calculate_hash(self, file_content):
        """Calcula hash del contenido del archivo para verificar duplicatas"""
...
# ... (mantenha todas as outras funções existentes do seu projeto)
...
def main():
    ...
    if pagina_selecionada == "Dashboard":
        ...
        # ... (seu código existente para atividades)
        st.title("Gestão de Atividades")
        # ... (restante do código de atividades)
        
    elif pagina_selecionada == "Relatórios":
        # ... (seu código existente para relatórios)
        st.title("Relatórios e Análises")
        # ... (restante do código de relatórios)
        
    elif pagina_selecionada == "Sistema CT-e":
        # Código do sistema CT-e
