...
# ==============================================================================
# PARTE 1: PARSER DO PDF "APP 2" (HÄFELE/EXTRATO) - LÓGICA CORRIGIDA
# ==============================================================================

class HafelePDFParser:
    """
    Parser atualizado para o layout Extrato DUIMP (APP2.pdf).
    Usa heurística de alíquotas para identificar PIS/COFINS/II/IPI.
    """
    ...
    def _process_full_text(self, text: str):
        # Separa o texto por itens usando o marcador padrão
    ...
    def _parse_item_block(self, item_num: int, text: str) -> Dict:
        try:
            ...
            # IMPOSTOS (Lógica de trios Base/Aliq/Valor)
            ...
            for base_str, aliq_str, val_str in tax_patterns:
                ...
                # IPI (o que sobrar e não for zero)
                elif aliq > 0:
...
# ==============================================================================
# PARTE 2: CONSTANTES (Tags e Campos)
# ==============================================================================
