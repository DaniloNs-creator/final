...
st.set_page_config(page_title="Häfele | DUIMP Converter V18 (Final)", page_icon="📦", layout="wide")
...
# ==============================================================================
# 3. PARSER V18 (STITCHING + LOCAL TAX SCANNER)
# ==============================================================================
...
class PDFParserV18:
    ...
    def preprocess(self):
        """
        Engine V18: Limpeza Cirúrgica de Cabeçalhos e Costura de Itens com Marcadores.
        """
        raw_text_parts = []
    ...
    def _extract_tax_robust(self, tax_label, block_text):
        """
        Escaneia o bloco LOCAl do item em busca de impostos.
        Garante que pegamos os valores específicos deste item.
        """
        ...
        if len(nums) >= 2:
            ...
            if candidates:
                ...
                rate = candidates[0][1]
                # Se tiver Base, Alíquota e Valor, o valor é o do meio ou menor.
                # Se só tiver Rate e Valor, Valor é o maior.
    ...
    def extract_items(self):
        ...
        if len(chunks) > 1:
            st.info(f"Processando {len(chunks)-1} itens encontrados...")
...
class XMLBuilder:
    ...
    def build(self):
        ...
        # Retorna string formatada (pretty print real)
